...
import { Box, Button, Checkbox, FormControl, IconButton, Input, InputGroup, InputRightElement, Tab, TabList, TabPanel, TabPanels, Tabs, useToast } from "@chakra-ui/react";
...
const Login = () => {
    ...
    const [loginEmail, setLoginEmail] = useState((localStorage.getItem("userEmailBMS")) || "");
    const [loginPass, setLoginPass] = useState((localStorage.getItem("userPassBMS")) || "");
    ...
    const handleLogin = () => {
        if (remember) {
            localStorage.setItem("userEmailBMS", loginEmail)
            localStorage.setItem("userPassBMS", loginPass)
        }
            ...
            <TabPanels>
                <TabPanel>
                    <FormControl textAlign={"center"} w={"90%"} m={"auto"}>
                        ...
                        <Checkbox m={1} colorScheme={"purple"} checked={remember} onChange={(e) => setRemember(e.target.checked)} >Remember Me</Checkbox>
                        <br />
                ...
                <TabPanel>
                    <FormControl textAlign={"center"} w={"90%"} m={"auto"}>
                        ...
                        <Button display={"block"} colorScheme="purple" m={"auto"} onClick={handleRegister}>Register</Button>
                    </FormControl>
                </TabPanel>
            </TabPanels>
        </Tabs>
